...
module ApplicationTests
  class AssetsTest < ActiveSupport::TestCase
    ...
    test "precompile creates a manifest file with all the assets listed" do
      ...
      asset_digests, source_digests = digests[:asset_digests], digests[:source_digests]

      assert_match(/application-([0-z]+)\.js/,  asset_digests["application.js"])
      assert_match(/application-([0-z]+)\.css/, asset_digests["application.css"])
    ...
    test "the manifest file should be saved by default in the same assets folder" do
      ...
      asset_digests = YAML.load_file(manifest)[:asset_digests]
      assert_match(/application-([0-z]+)\.js/, asset_digests["application.js"])
    end
    ...
    test "precompile does not append asset digests when config.assets.digest is false" do
      ...
      asset_digests = YAML.load_file(manifest)[:asset_digests]
      assert_equal "application.js", asset_digests["application.js"]
      assert_equal "application.css", asset_digests["application.css"]
    end
    ...
    test "assets do not require any assets group gem when manifest file is present" do
      ...
      manifest = "#{app_path}/public/assets/manifest.yml"
      asset_digests = YAML.load_file(manifest)[:asset_digests]
      asset_path = asset_digests["application.js"]
    ...
    test "assets raise AssetNotPrecompiledError when manifest file is present and requested file isn't precompiled if digest is disabled" do
      ...
      add_to_config "config.assets.asset_digests = false"
    ...
    test "precompile shouldn't use the digests present in manifest.yml" do
      ...
      assert_not_equal asset_path, asset_digests["application.css"]
    end
